...
Use this template to document **your application** and how it connects to the CTRL BOARD platform. This describes YOUR app — not CTRL BOARD itself. CTRL BOARD is already built; this template captures how your app sends data to it and reads configuration from it.

> **Reminder:** Your app is a standalone application. CTRL BOARD is a separate standalone application. The "integration" is the connection between them — your app installing the SDK, sending metrics, and optionally reading customer config from Firebase. You do NOT build any admin UI, dashboard, or management features — those already exist in CTRL BOARD.
