...
This guide walks you through connecting your existing application to the already-running CTRL BOARD platform. It takes about 15 minutes.

> **You are NOT building a control board.** CTRL BOARD is a separate, standalone application that is already built, deployed, and running. This guide shows you how to **connect your app to it** — by installing the SDK and calling a few methods. You will not create any admin UI, dashboard, analytics page, or management screen. All of that already exists inside CTRL BOARD.

### What you will do in this guide:
1. Register your app in CTRL BOARD (get an API key)
2. Install the SDK in your app's codebase (`npm install @ctrlboard/sdk`)
3. Add ~10-20 lines of code to send data to CTRL BOARD
4. (Optional) Subscribe to Firebase to read customer config

### What you will NOT do:
- Build any admin dashboard or analytics UI
- Create database schemas for monitoring or billing
- Write a theme editor, user management, or alerting system
- Deploy or host CTRL BOARD (it's already deployed)
